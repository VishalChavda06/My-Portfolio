...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-r from-green-100 via-pink-100 to-green-100 py-20">
      ...
      {/* My Story And Expertise Section */}
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            
            {/* Left Side - Profile Image and Elements */}
            <div className="relative">
              {/* Decorative Green Shape */}
              <div className="absolute -left-8 -top-8 w-32 h-32 bg-green-500 rounded-full opacity-20"></div>
              <div className="absolute -left-4 -top-4 w-24 h-24 bg-green-400 rounded-full opacity-30"></div>
              ...
              <div className="relative z-10">
                <img 
                  src={meImage} 
                  alt="Vishal Chavda" 
                  className="w-80 h-96 object-cover object-top rounded-lg shadow-2xl"
                />
              </div>

              {/* Floating Hire Me Button */}
              <div className="absolute top-8 -right-8 bg-black text-white rounded-full w-24 h-24 flex flex-col items-center justify-center transform rotate-12 hover:scale-110 transition-transform duration-300 cursor-pointer">
              ...
              <div className="absolute -bottom-2 -left-8 w-4 h-4 bg-green-400 rounded-full opacity-40"></div>
            </div>

            {/* Right Side - Content */}
            <div className="space-y-8">
              {/* Decorative Star */}
              <div className="absolute top-0 right-0 w-16 h-16 bg-green-200 rounded-full opacity-30"></div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                With a passion for technology and years of experience, I specialize in web, mobile, AI, and blockchain development. My expertise lies in creating innovative, scalable, and efficient solutions that help businesses.
              </p>
              ...
              <div className="grid grid-cols-3 gap-8 py-8">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-gray-800 mb-2">520+</div>
                  <div className="text-sm text-gray-600">Project Completed</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-gray-800 mb-2">600+</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-green-500 text-white px-8 py-4 rounded-lg font-medium flex items-center justify-center space-x-2 hover:bg-green-600 transition-colors duration-300">
                  <span>About Me</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                  </svg>
                </button>
                <button className="border-2 border-gray-800 text-gray-800 px-8 py-4 rounded-lg font-medium flex items-center justify-center space-x-2 hover:bg-gray-800 hover:text-white transition-colors duration-300">
